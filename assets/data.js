var data = [
    ...
    },
    {
        ...
        description: [
            `- Dùng miêu tả sự việc/ hành động/ tính chất tương tự với một sự việc/ hành động/ tính chất đã nêu trước đó. (nhằm tránh lặp lại trợ từ “は”/động từ nhiều lần) <br/>
        - Thể hiện sự ngạc nhiên về mức độ nhiều.  <br/>
        - Thể hiện mức độ không giống như bình thường (cao hơn hoặc thấp hơn). <br/>
    ...
    },
    {
        ...
        description: [
            `- Diễn tả nơi xảy ra hành động. <br/>
            - Diễn tả nơi xảy ra sự kiện.<br/>
            -  Diễn tả nguyên nhân.<br/>
            -  Diễn tả phương pháp, phương thức, phương tiện.<br/>
            -  Diễn tả sự vật được làm bằng vật liệu/chất liệu gì.<br/>
            -   Diễn tả một khoảng thời gian giới hạn.<br/>
        `,
            ,
        ],
        example: [
    ...
    },
    {
        ...
        description: [
            `- N（時間又は場所 / Thời gian hoặc địa điểm）＋に/へ <br/>
        - Dùng để chỉ địa điểm.  <br/>
        - Dùng để chỉ thời điểm.  <br/>
        - Dùng để chỉ hướng đến ai.  <br/>
        - Khi muốn nói về thời điểm mà một hành động nào đó xảy ra, chúng ta thêm trợ từ「に」vào sau danh từ chỉ thời gian. Dùng「に」đối với những hành động diễn ra trong thời gian ngắn. <br/>
