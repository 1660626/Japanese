...
!(function ($) {
  ...
  $(window).on('load', function () {
    ...
    $('#sentences .box-result').on('click', ".item-result ", function () {
      ...
      var name =$(this).attr('name-voice');
        $(this).children().children("#myAudio").append(`F <source src="https://koyjapanese.herokuapp.com/voice/${name}.mp3" type="audio/mpeg">`);
  ...
  fetch('https://koyjapanese.herokuapp.com/noti').then(function (response) {
